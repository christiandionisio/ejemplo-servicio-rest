...
@ControllerAdvice
@RestController
public class ErroresHandler extends ResponseEntityExceptionHandler{

	@ExceptionHandler(Exception.class)
	public ResponseEntity<ExceptionResponse> manejarTodasException(Exception ex, WebRequest request) {
